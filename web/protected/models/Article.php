...
class Article extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			//array(' audit_user_id, enterprise_id, create_user_id', 'numerical', 'integerOnly'=>true),
			array('article_tag, article_name', 'length', 'max'=>256),
			array('article_summary', 'length', 'max'=>1024),
			//array('article_reject_reason', 'length', 'max'=>512, 'ecoding'=>'utf-8'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('article_id, article_tag, article_url, article_icon, article_type, article_name, article_status, article_content, article_summary, article_isbanner, article_audit_gmt, article_create_gmt, article_update_gmt, article_click_count, article_reject_reason, column_id, audit_user_id, enterprise_id, create_user_id', 'safe', 'on'=>'search'),
		);
	}
