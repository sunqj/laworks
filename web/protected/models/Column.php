...
class Column extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('column_index, column_status, column_create_gmt, column_update_gmt, enterprise_id', 'numerical', 'integerOnly'=>true),
			array('column_icon, column_name, column_desc', 'length', 'max'=>1024),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('column_id, column_icon, column_name, column_desc, column_index, column_status, column_create_gmt, column_update_gmt, enterprise_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getColumnList($enterprise_id)
	{
	    $columnList = Column::model()->findAllByAttributes(array("enterprise_id" => $enterprise_id));
// 	    echo "<pre>";
// 	    print_r($columnList);
// 	    echo "</pre>";
//         echo "<pre>";
