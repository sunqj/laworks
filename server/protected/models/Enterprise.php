...
class Enterprise extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('enterprise_status, enterprise_audit, enterprise_user_history', 'numerical', 'integerOnly'=>true),
			array('enterprise_name', 'length', 'max'=>128),
			array('enterprise_desc, enterprise_logo', 'length', 'max'=>1024),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('enterprise_id, enterprise_name, enterprise_desc, enterprise_logo, enterprise_status, enterprise_audit, enterprise_user_history', 'safe', 'on'=>'search'),
		);
	}
