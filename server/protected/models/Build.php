...
class Build extends CActiveRecord
{
    ...
    public static function buildApk($enterpriseId, $themeDir, $appname, $branchName, $timeStamp)
    {
        ...
        $srcDir = '/backup/code/client/devilworks-platform';
    ...
    {
    	$verArray = explode("-", $clientVer);
    	$buildDate = $verArray[1];
        $buildArray = Build::model()->findAll("build_date > $buildDate and enterprise_id = $eId 
        ...
        $verInfo['url']    = "/apk/$eId/$latest->build_version.apk";
        return $verInfo;
    }
}